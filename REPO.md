# Open Source Repos for Contribution

Repos I want to contribute to. Add a row (or just paste a URL and ask me to fill it in).

| Repo | URL | Language | Good first issues | Notes | Status |
|------|-----|----------|-------------------|-------|--------|
